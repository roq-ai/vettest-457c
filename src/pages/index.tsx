  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Vettest - Streamlining Pet Care for Small Clinics. An intuitive vet management system designed to track patients, add notes, upload exam results, and elevate your pet care services."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1596272875729-ed2ff7d6d9c5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2ZXRlcmluYXJ5fGVufDB8fHx8MTY5NTA1MDMwNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@berzk?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Werzk Luuuuuuu`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Vettest - Streamlining Pet Care for Small Clinics. An intuitive vet management system designed to track patients, add notes, upload exam results, and elevate your pet care services.`}
            </Text>
            <Box
