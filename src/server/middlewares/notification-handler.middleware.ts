...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'note.create': {
    roles: ['owner', 'veterinarian', 'veterinary-nurse'],
    key: 'new-note-added',
    tenantPath: ['clinic', 'user', 'note'],
    userPath: [],
  },
  'file.create': {
    roles: ['owner', 'veterinarian', 'veterinary-nurse'],
    key: 'new-file-uploaded',
    tenantPath: ['clinic', 'user', 'file'],
    userPath: [],
  },
  'user.delete': { roles: ['owner'], key: 'user-profile-deleted', tenantPath: ['clinic', 'user'], userPath: [] },
  'customer, pet.delete': {
    roles: ['owner', 'veterinarian', 'veterinary-nurse'],
    key: 'customer-or-pet-profile-deleted',
    tenantPath: [],
    userPath: [],
  },
};
